...
set(CPACK_PACKAGE_VENDOR ${beeCopter_ORG_NAME})
...
set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}/resources/icons/beeCopter.png")
if(APPLE)
    set(beeCopter_APP_ICON "${CMAKE_SOURCE_DIR}/deploy/macos/beeCopter.icns")
elseif(WIN32)
    set(beeCopter_APP_ICON "${CMAKE_SOURCE_DIR}/resources/icons/beeCopter.ico")
else()
    set(beeCopter_APP_ICON "${CMAKE_SOURCE_DIR}/resources/icons/beeCopter.png")
endif()
