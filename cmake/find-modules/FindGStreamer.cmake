...
if(NOT DEFINED GStreamer_FIND_VERSION)
    ...
    elseif(WIN32)
        set(GStreamer_FIND_VERSION ${beeCopter_CONFIG_GSTREAMER_WIN_VERSION})
    elseif(ANDROID)
        set(GStreamer_FIND_VERSION ${beeCopter_CONFIG_GSTREAMER_ANDROID_VERSION})
    elseif(MACOS OR IOS)
        set(GStreamer_FIND_VERSION ${beeCopter_CONFIG_GSTREAMER_MACOS_VERSION})
    else()
        set(GStreamer_FIND_VERSION ${beeCopter_CONFIG_GSTREAMER_VERSION})
    endif()
endif()
...
# ----------------------------------------------------------------------------
elseif(ANDROID)
    if(beeCopter_CUSTOM_GST_PACKAGE)
        set(_gst_android_url "https://beeCopter.s3.us-west-2.amazonaws.com/android-gstreamer/beeCopter-android-gstreamer-${GStreamer_FIND_VERSION}.tar.xz")
    else()
...
if(GStreamer_FOUND AND NOT TARGET GStreamer::GStreamer)
    ...
    if(GStreamer_USE_STATIC_LIBS)
        target_compile_definitions(GStreamer::GStreamer INTERFACE beeCopter_GST_STATIC_BUILD)
    endif()
    ...
    if(APPLE AND GStreamer_USE_FRAMEWORK)
        ...
        if(GSTREAMER_FRAMEWORK)
            ...
            if(MACOS)
                target_compile_definitions(GStreamer::GStreamer INTERFACE beeCopter_GST_MACOS_FRAMEWORK)
            endif()
            return()
        else()
