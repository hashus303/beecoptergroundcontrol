...
Q_DECLARE_LOGGING_CATEGORY(beeCopterVideoStreamInfoLog)
...
class beeCopterVideoStreamInfo : public QObject
{
    Q_OBJECT
    QML_ELEMENT
    QML_UNCREATABLE("")
...
public:
    explicit beeCopterVideoStreamInfo(const mavlink_video_stream_information_t &info, QObject *parent = nullptr);
...
Q_DECLARE_METATYPE(beeCopterVideoStreamInfo::QVIDEO_STREAM_STATUS_FLAGS)
