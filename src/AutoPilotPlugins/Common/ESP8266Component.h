...
public:
    ...
    QUrl setupSource() const final { return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/Common/ESP8266Component.qml"); }
    QUrl summaryQmlSource() const final { return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/Common/ESP8266ComponentSummary.qml"); }
