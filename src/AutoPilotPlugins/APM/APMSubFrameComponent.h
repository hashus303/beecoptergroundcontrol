...
public:
    ...
    QUrl setupSource() const final { return QUrl::fromUserInput(QStringLiteral("qrc:/qml/beeCopter/AutoPilotPlugins/APM/APMSubFrameComponent.qml")); }
    QUrl summaryQmlSource() const final { return QUrl::fromUserInput(QStringLiteral("qrc:/qml/beeCopter/AutoPilotPlugins/APM/APMSubFrameComponentSummary.qml")); }
