...
{
    return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/PX4/SafetyComponent.qml");
}

QUrl SafetyComponent::summaryQmlSource(void) const
{
    return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/PX4/SafetyComponentSummary.qml");
}
