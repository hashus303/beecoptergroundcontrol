...
{
    return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/PX4/PX4FlightModes.qml");
}

QUrl FlightModesComponent::summaryQmlSource(void) const
{
    return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/PX4/FlightModesComponentSummary.qml");
}
