...
{
    return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/Common/RadioComponent.qml");
}

QUrl PX4RadioComponent::summaryQmlSource(void) const
{
    return QUrl::fromUserInput("qrc:/qml/beeCopter/AutoPilotPlugins/PX4/PX4RadioComponentSummary.qml");
}
