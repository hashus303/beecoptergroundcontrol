...
double beeCopterGeoBoundingCube::MaxAlt    =  1000000.0;
double beeCopterGeoBoundingCube::MinAlt    = -1000000.0;
double beeCopterGeoBoundingCube::MaxNorth  =  90.0;
double beeCopterGeoBoundingCube::MaxSouth  = -90.0;
double beeCopterGeoBoundingCube::MaxWest   = -180.0;
double beeCopterGeoBoundingCube::MaxEast   =  180.0;

//-----------------------------------------------------------------------------
beeCopterGeoBoundingCube::beeCopterGeoBoundingCube(QObject* parent)
    : QObject(parent)
{
    reset();
}
...
//-----------------------------------------------------------------------------
bool
beeCopterGeoBoundingCube::isValid() const
{
...
//-----------------------------------------------------------------------------
void
beeCopterGeoBoundingCube::reset()
{
...
//-----------------------------------------------------------------------------
QGeoCoordinate
beeCopterGeoBoundingCube::center() const
{
    if(!isValid())
...
beeCopterGeoBoundingCube::polygon2D(double clipTo) const
{
...
//-----------------------------------------------------------------------------
bool
beeCopterGeoBoundingCube::operator ==(const QList<QGeoCoordinate>& coords) const
{
...
//-----------------------------------------------------------------------------
double
beeCopterGeoBoundingCube::width() const
{
    if(!isValid())
        return 0.0;
...
//-----------------------------------------------------------------------------
double
beeCopterGeoBoundingCube::height() const
{
    if(!isValid())
        return 0.0;
...
//-----------------------------------------------------------------------------
double
beeCopterGeoBoundingCube::area() const
{
    if(!isValid())
        return 0.0;
    // Area in km^2
...
//-----------------------------------------------------------------------------
double
beeCopterGeoBoundingCube::radius() const
{
    if(!isValid())
        return 0.0;
