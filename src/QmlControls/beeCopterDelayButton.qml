...
DelayButton {
    ...
    background: Rectangle {
        ...
        color:          control._showHighlight ? beeCopterPal.buttonHighlight : beeCopterPal.button
        ...
        beeCopterColoredImage {
            ...
            color:                  control._showHighlight ? beeCopterPal.buttonHighlightText : beeCopterPal.buttonText
