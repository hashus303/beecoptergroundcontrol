...
class beeCopterMapPolyline : public QObject
{
    Q_OBJECT

public:
    beeCopterMapPolyline(QObject* parent = nullptr);
    beeCopterMapPolyline(const beeCopterMapPolyline& other, QObject* parent = nullptr);

    ~beeCopterMapPolyline() override;

    const beeCopterMapPolyline& operator=(const beeCopterMapPolyline& other);
