...
Button {
    ...
    background: Rectangle {
        anchors.fill:   parent
        color:          button.checked ? beeCopterPal.buttonHighlight : Qt.rgba(0,0,0,0)
        border.color:   "red"
        border.width:   beeCopter.corePlugin.showTouchAreas ? 3 : 0
    }
    ...
    contentItem: Row {
        ...
        beeCopterColoredImage {
            ...
            color:                  logo ? "transparent" : (button.checked ? beeCopterPal.buttonHighlightText : beeCopterPal.buttonText)
        ...
        Label {
            ...
            visible:                text !== ""
            text:                   button.text
            color:                  button.checked ? beeCopterPal.buttonHighlightText : beeCopterPal.buttonText
            anchors.verticalCenter: parent.verticalCenter
        }
    }
}
