...
ComboBox {
    ...
    property var    _controlbeeCopterPal: beeCopterPalette { colorGroupEnabled: enabled }
    property bool   _flashChecked
    property string _flashText
    property bool   _showFlash:     false

    Component.onCompleted: indicator.color = Qt.binding(function() { return _controlbeeCopterPal.text })

    background: Rectangle {
        implicitWidth:                  ScreenTools.implicitComboBoxWidth
        implicitHeight:                 ScreenTools.implicitComboBoxHeight
        color:                          _controlbeeCopterPal.window
    ...
    delegate: ItemDelegate {
        ...
        property var _itembeeCopterPal:       beeCopterPalette { colorGroupEnabled: enabled }
        ...
        contentItem: RowLayout {
            ...
            Rectangle {
                ...
                width:          height
                border.color:   _itembeeCopterPal.buttonText
                border.width:   1
                color:          _itembeeCopterPal.button
                ...
                beeCopterColoredImage {
                    ...
                    color:              _itembeeCopterPal.buttonText
                    mipmap:             true
        ...
        background: Rectangle {
            color: _controlbeeCopterPal.button
        }
    ...
    contentItem: Item {
        ...
        beeCopterLabel {
            ...
            text:                       labelText
            color:                      _controlbeeCopterPal.text
            visible:                    !_showFlash
        }
        ...
        RowLayout {
            ...
            Rectangle {
                height:         ScreenTools.defaultFontPixelHeight
                width:          height
                border.color:   _controlbeeCopterPal.buttonText
                border.width:   1
                color:          _controlbeeCopterPal.window
            ...
            Text {
                text:   _flashText
                color:  _controlbeeCopterPal.buttonText
            }
