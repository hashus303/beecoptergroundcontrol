...
class beeCopterGeoBoundingCube : public QObject
{
    Q_OBJECT
    QML_ELEMENT
    QML_UNCREATABLE("")
public:
    beeCopterGeoBoundingCube(QObject* parent = nullptr);

    beeCopterGeoBoundingCube(const beeCopterGeoBoundingCube& other)
        : QObject()
    {
    ...
    beeCopterGeoBoundingCube(QGeoCoordinate p1, QGeoCoordinate p2)
        : pointNW(p1)
        , pointSE(p2)
    {
    }
    ...
    inline bool operator ==(const beeCopterGeoBoundingCube& other) const
    {
    ...
    inline bool operator !=(const beeCopterGeoBoundingCube& other)
    {
        return !(*this == other);
    }

    inline const beeCopterGeoBoundingCube& operator =(const beeCopterGeoBoundingCube& other)
    {
        pointNW = other.pointNW;
        pointSE = other.pointSE;
        return *this;
