...
TextField {
    ...
    selectionColor:     beeCopterPal.textFieldText
    selectedTextColor:  beeCopterPal.textField
    ...
    background: Rectangle {
        border.width:   control.validationError ? 2 : (beeCopterPal.globalTheme === beeCopterPalette.Light ? 1 : 0)
        border.color:   control.validationError ? beeCopterPal.colorRed : beeCopterPal.buttonBorder
