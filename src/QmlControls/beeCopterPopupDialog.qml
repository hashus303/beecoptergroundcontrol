...
// Provides the standard dialog mechanism for beeCopter. Works 99% like Qml Dialog.
//
// Example usage:
//      Component {
//          id: dialogComponent
...
//
// Notes:
//  * beeCopterPopupDialog should be created from a component to limit the memory usage of the dialog
//      to only when it is displayed.
//  * Parent for createObject should always be mainWindow.
// Differences from standard Qml Dialog:
//  * The beeCopterPopupDialog object will automatically be destroyed when it closed. You can override this
...
Popup {
    ...
    Rectangle {
        ...
        color:          _beeCopterPal.windowShade
        radius:         root.padding / 2
        border.width:   1
        border.color:   _beeCopterPal.windowShadeLight
    }
