...
class beeCopterSerialPortInfoTest;

Q_DECLARE_LOGGING_CATEGORY(beeCopterSerialPortInfoLog)

/// beeCopter's version of Qt QSerialPortInfo. It provides additional information about board types
/// that beeCopter cares about.
class beeCopterSerialPortInfo : public QSerialPortInfo
{
    friend class beeCopterSerialPortInfoTest;
public:
    beeCopterSerialPortInfo();
    explicit beeCopterSerialPortInfo(const QSerialPort &port);
    ~beeCopterSerialPortInfo();
    ...
    static QList<beeCopterSerialPortInfo> availablePorts();
...
Q_DECLARE_METATYPE(beeCopterSerialPortInfo)
