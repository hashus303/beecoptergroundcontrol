...
beeCopter_LOGGING_CATEGORY(beeCopterMAVLinkLog, "MAVLink.beeCopterMAVLink")

const QHash<int, QString> beeCopterMAVLink::mavlinkCompIdHash {
...
#endif
    if (!beeCopterMAVLink::isValidChannel(channel)) {
        qCWarning(beeCopterMAVLinkLog) << Q_FUNC_INFO << "Invalid Channel Number:" << channel;
        return nullptr;
    }
...
beeCopterMAVLink::beeCopterMAVLink(QObject *parent)
    : QObject(parent)
{
   ...
   (void) qRegisterMetaType<beeCopterMAVLink::GripperActions>("beeCopterMAVLink::GripperActions");
}

beeCopterMAVLink::~beeCopterMAVLink()
{
    // qCDebug(StatusTextHandlerLog) << Q_FUNC_INFO << this;
}

QList<beeCopterMAVLink::FirmwareClass_t> beeCopterMAVLink::allFirmwareClasses(void)
{
    static const QList<beeCopterMAVLink::FirmwareClass_t> classes = {
        FirmwareClassPX4,
...
QList<beeCopterMAVLink::VehicleClass_t> beeCopterMAVLink::allVehicleClasses(void)
{
    static const QList<beeCopterMAVLink::VehicleClass_t> classes = {
...
beeCopterMAVLink::FirmwareClass_t beeCopterMAVLink::firmwareClass(MAV_AUTOPILOT autopilot)
{
...
QString beeCopterMAVLink::firmwareClassToString(FirmwareClass_t firmwareClass)
{
...
MAV_AUTOPILOT beeCopterMAVLink::firmwareTypeFromString(const QString &firmwareTypeStr)
{
...
bool beeCopterMAVLink::isAirship(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassAirship;
}

bool beeCopterMAVLink::isFixedWing(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassFixedWing;
}

bool beeCopterMAVLink::isRoverBoat(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassRoverBoat;
}

bool beeCopterMAVLink::isSpacecraft(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassSpacecraft;
}

bool beeCopterMAVLink::isSub(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassSub;
}

bool beeCopterMAVLink::isMultiRotor(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassMultiRotor;
}

bool beeCopterMAVLink::isVTOL(MAV_TYPE mavType)
{
    return vehicleClass(mavType) == VehicleClassVTOL;
}

beeCopterMAVLink::VehicleClass_t beeCopterMAVLink::vehicleClass(MAV_TYPE mavType)
{
    switch (mavType) {
...
QString beeCopterMAVLink::vehicleClassToUserVisibleString(VehicleClass_t vehicleClass)
{
    switch (vehicleClass) {
...
MAV_TYPE beeCopterMAVLink::vehicleTypeFromString(const QString &vehicleStr)
{
...
QString beeCopterMAVLink::vehicleClassToInternalString(VehicleClass_t vehicleClass)
{
    switch (vehicleClass) {
    case VehicleClassAirship:
...
QString beeCopterMAVLink::mavResultToString(uint8_t result)
{
    switch (result) {
...
QString beeCopterMAVLink::mavSysStatusSensorToString(MAV_SYS_STATUS_SENSOR sysStatusSensor)
{
    struct sensorInfo_s {
        uint32_t    bit;
        QString     sensorName;
    ...
    qWarning() << "beeCopterMAVLink::mavSysStatusSensorToString: Unknown sensor" << sysStatusSensor;

    return QT_TRANSLATE_NOOP("MAVLink unknown SYS_STATUS_SENSOR value", "Unknown sensor");
}

QString beeCopterMAVLink::mavTypeToString(MAV_TYPE mavType) {
...
QString beeCopterMAVLink::firmwareVersionTypeToString(FIRMWARE_VERSION_TYPE firmwareVersionType)
{
...
FIRMWARE_VERSION_TYPE beeCopterMAVLink::firmwareVersionTypeFromString(const QString &typeStr)
{
...
int beeCopterMAVLink::motorCount(MAV_TYPE mavType, uint8_t frameType)
{
    switch (mavType) {
    case MAV_TYPE_HELICOPTER:
        return 1;
...
uint32_t beeCopterMAVLink::highLatencyFailuresToMavSysStatus(mavlink_high_latency2_t& highLatency2)
{
...
QString beeCopterMAVLink::compIdToString(uint8_t compId)
{
    QString compIdStr;
