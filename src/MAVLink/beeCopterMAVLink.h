...
Q_DECLARE_LOGGING_CATEGORY(beeCopterMAVLinkLog)
// Q_DECLARE_METATYPE(mavlink_message_t)
Q_DECLARE_METATYPE(MAV_TYPE)
Q_DECLARE_METATYPE(MAV_AUTOPILOT)

class beeCopterMAVLink : public QObject
{
    Q_OBJECT
...
public:
    // Creating an instance of beeCopterMAVLink is only meant to be used for the Qml Singleton
    beeCopterMAVLink(QObject *parent = nullptr);
    ~beeCopterMAVLink();
...
Q_DECLARE_METATYPE(beeCopterMAVLink::GripperActions)
