...
public:
    ...
    explicit beeCopterTileCacheDatabase(const QString &databasePath);
    ~beeCopterTileCacheDatabase();
    ...
    std::unique_ptr<beeCopterCacheTile> getTile(const QString &hash);
    ...
    // Downloads
    QList<beeCopterTile> getTileDownloadList(quint64 setID, int count);
