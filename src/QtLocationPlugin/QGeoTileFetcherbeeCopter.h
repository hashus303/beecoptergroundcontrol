...
Q_DECLARE_LOGGING_CATEGORY(QGeoTileFetcherbeeCopterLog)

class QGeoTiledMappingManagerEnginebeeCopter;
class QGeoTiledMapReplybeeCopter;
class QGeoTileSpec;
class QNetworkAccessManager;

class QGeoTileFetcherbeeCopter : public QGeoTileFetcher
{
    Q_OBJECT

public:
    explicit QGeoTileFetcherbeeCopter(QNetworkAccessManager *networkManager, const QVariantMap &parameters, QGeoTiledMappingManagerEnginebeeCopter *parent = nullptr);
    ~QGeoTileFetcherbeeCopter();
