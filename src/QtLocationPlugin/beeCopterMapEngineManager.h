...
Q_DECLARE_LOGGING_CATEGORY(beeCopterMapEngineManagerLog)

class beeCopterCachedTileSet;
class beeCopterCompressionJob;
class QmlObjectListModel;

class beeCopterMapEngineManager : public QObject
{
    Q_OBJECT
    // QML_ELEMENT
    // QML_UNCREATABLE("")
    Q_MOC_INCLUDE("QmlObjectListModel.h")
    Q_MOC_INCLUDE("beeCopterCachedTileSet.h")
...
public:
    explicit beeCopterMapEngineManager(QObject *parent = nullptr);
    ~beeCopterMapEngineManager();
    static beeCopterMapEngineManager *instance();
    ...
    Q_INVOKABLE void deleteTileSet(beeCopterCachedTileSet *tileSet);
    Q_INVOKABLE void loadTileSets();
    Q_INVOKABLE void renameTileSet(beeCopterCachedTileSet *tileSet, const QString &newName);
...
public slots:
    void taskError(beeCopterMapTask::TaskType type, const QString &error);
...
private slots:
    ...
    void _tileSetFetched(beeCopterCachedTileSet *tileSets);
    void _tileSetSaved(beeCopterCachedTileSet *set);
...
private:
    ...
    beeCopterTileSet _imageSet;
    beeCopterTileSet _elevationSet;
    ...
    static constexpr const char *kQmlOfflineMapKeyName = "beeCopterOfflineMap";
};
