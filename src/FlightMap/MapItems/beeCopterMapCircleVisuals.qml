...
/// beeCopterMapCircle map visuals
Item {
    id: _root

    property var    mapControl                                                        ///< Map control to place item in
    property var    mapCircle                                                         ///< beeCopterMapCircle object
    ...
    property color  borderColor:              beeCopter.globalPalette.mapMissionTrajectory
        ...
        MapQuickItem {
            ...
            sourceItem: Item {
                ...
                beeCopterLabel {
                    ...
                    color:                  "black"
                    text:                   beeCopter.unitsConversion.metersToAppSettingsHorizontalDistanceUnits(_radius).toFixed(0) +
                                            " " + beeCopter.unitsConversion.appSettingsHorizontalDistanceUnitsString
