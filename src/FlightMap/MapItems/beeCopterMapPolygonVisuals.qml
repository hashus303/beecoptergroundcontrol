...
/// beeCopterMapPolygon map visuals
Item {
    id: _root

    property var    mapControl                                  ///< Map control to place item in
    property var    mapPolygon                                  ///< beeCopterMapPolygon object
    ...
    property real _zorderDragHandle:    beeCopter.zOrderMapItems + 3   // Highest to prevent splitting when items overlap
    property real _zorderSplitHandle:   beeCopter.zOrderMapItems + 2
    property real _zorderCenterHandle:  beeCopter.zOrderMapItems + 1   // Lowest such that drag or split takes precedence
    ...
    function addToolbarVisuals() {
        if (_objMgrToolVisuals.empty) {
            ...
            toolbar.z = beeCopter.zOrderWidgets
        }
    }
    ...
    beeCopterDynamicObjectManager { id: _objMgrToolVisuals }
    beeCopterDynamicObjectManager { id: _objMgrEditingVisuals }
    beeCopterDynamicObjectManager { id: _objMgrTraceVisuals }
    beeCopterDynamicObjectManager { id: _objMgrCircleVisuals }
