...
Q_DECLARE_LOGGING_CATEGORY(beeCopterCommandLineParserLog)
...
/// command-line options are only available in beeCopter_UNITTEST_BUILD.
struct CommandLineParseResult
{
    ...
    // --- Test options (command-line parsing only in beeCopter_UNITTEST_BUILD) ---
