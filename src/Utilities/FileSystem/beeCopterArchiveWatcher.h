...
/// @file beeCopterArchiveWatcher.h
...
Q_DECLARE_LOGGING_CATEGORY(beeCopterArchiveWatcherLog)
...
/// Example usage:
/// @code
/// beeCopterArchiveWatcher watcher;
/// watcher.setAutoDecompress(true);
/// watcher.setOutputDirectory("/extracted");
/// connect(&watcher, &beeCopterArchiveWatcher::archiveDetected,
///         [](const QString &path) {
///     qDebug() << "Found archive:" << path;
/// });
/// connect(&watcher, &beeCopterArchiveWatcher::extractionComplete,
...
/// @endcode
class beeCopterArchiveWatcher : public QObject
{
    Q_OBJECT
    Q_DISABLE_COPY_MOVE(beeCopterArchiveWatcher)
...
public:
    ...
    explicit beeCopterArchiveWatcher(QObject *parent = nullptr);
    ~beeCopterArchiveWatcher() override;
    ...
    /// Set debounce delay (inherited from beeCopterFileWatcher)
...
signals:
    ...
    void archiveDetected(const QString &archivePath, beeCopterCompression::Format format);
...
private:
    ...
    beeCopterFileWatcher *_fileWatcher = nullptr;
