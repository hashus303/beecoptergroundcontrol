...
/// @file beeCopterCachedFileDownload.h
...
class beeCopterFileDownload;
class QNetworkDiskCache;

Q_DECLARE_LOGGING_CATEGORY(beeCopterCachedFileDownloadLog)
...
/// Example C++ usage:
/// @code
/// auto *downloader = new beeCopterCachedFileDownload("/path/to/cache", this);
/// connect(downloader, &beeCopterCachedFileDownload::finished, this,
...
/// }
/// @endcode
class beeCopterCachedFileDownload : public QObject
{
    Q_OBJECT
    Q_DISABLE_COPY_MOVE(beeCopterCachedFileDownload)
...
public:
    ...
    explicit beeCopterCachedFileDownload(const QString &cacheDirectory, QObject *parent = nullptr);

    /// Construct without cache directory (must call setCacheDirectory before use)
    explicit beeCopterCachedFileDownload(QObject *parent = nullptr);

    ~beeCopterCachedFileDownload() override;
    ...
    beeCopterFileDownload *fileDownloader() const { return _fileDownload; }
...
private:
    ...
    beeCopterFileDownload *_fileDownload = nullptr;
