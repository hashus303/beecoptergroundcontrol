...
Q_DECLARE_LOGGING_CATEGORY(beeCopterFileDownloadLog)
...
/// Example C++ usage:
/// @code
/// auto *download = new beeCopterFileDownload(this);
/// connect(download, &beeCopterFileDownload::finished, this,
...
/// }
/// @endcode
class beeCopterFileDownload : public QObject
{
    Q_OBJECT
    Q_DISABLE_COPY_MOVE(beeCopterFileDownload)
...
public:
    ...
    explicit beeCopterFileDownload(QObject *parent = nullptr);
    ~beeCopterFileDownload() override;
...
public slots:
    ...
    /// @return true if download started successfully
    bool start(const QString &remoteUrl, const beeCopterNetworkHelper::RequestConfig &config);
...
private:
    ...
    beeCopterCompressionJob *_decompressionJob = nullptr;
    ...
    int _timeoutMs = beeCopterNetworkHelper::kDefaultTimeoutMs;
