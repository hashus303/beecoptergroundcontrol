...
Q_DECLARE_LOGGING_CATEGORY(beeCopterArchiveFileLog)
...
/// Example usage:
/// @code
/// beeCopterArchiveFile file("archive.zip", "config.json");
/// file.open(QIODevice::ReadOnly);
/// QJsonDocument doc = QJsonDocument::fromJson(file.readAll());
/// @endcode
class beeCopterArchiveFile : public beeCopterArchiveDeviceBase
{
    Q_OBJECT
...
public:
    ...
    beeCopterArchiveFile(const QString &archivePath, const QString &entryName, QObject *parent = nullptr);
    ...
    beeCopterArchiveFile(QIODevice *source, const QString &entryName, QObject *parent = nullptr);

    ~beeCopterArchiveFile() override = default;
