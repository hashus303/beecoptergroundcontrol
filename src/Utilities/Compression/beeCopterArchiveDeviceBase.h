...
/// @file beeCopterArchiveDeviceBase.h
...
class beeCopterArchiveDeviceBase : public QIODevice
{
    Q_OBJECT

public:
    ~beeCopterArchiveDeviceBase() override;
...
protected:
    ...
    explicit beeCopterArchiveDeviceBase(const QString &filePath, QObject *parent = nullptr);
    ...
    explicit beeCopterArchiveDeviceBase(QIODevice *source, QObject *parent = nullptr);
