...
/// Usage in QML:
/// @code
/// import beeCopter.Utilities
///
/// ListView {
///     model: beeCopterArchiveModel {
...
/// }
/// @endcode
class beeCopterArchiveModel : public QAbstractListModel
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    ...
    explicit beeCopterArchiveModel(QObject *parent = nullptr);
    ~beeCopterArchiveModel() override;
...
private:
    ...
    QList<beeCopterCompression::ArchiveEntry> _allEntries;      ///< All entries from archive
    QList<beeCopterCompression::ArchiveEntry> _filteredEntries; ///< Entries after filter applied
    int _fileCount = 0;
