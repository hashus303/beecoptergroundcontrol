...
/// @file beeCopterlibarchive.h
/// @brief Private implementation details for beeCopterCompression
/// @note This is an internal header - use beeCopterCompression.h for public API

#include "beeCopterCompressionTypes.h"
...
Q_DECLARE_LOGGING_CATEGORY(beeCopterlibarchiveLog)

namespace beeCopterlibarchive {

// ============================================================================
// Types (re-export from beeCopterCompression for internal use)
// ============================================================================

using ProgressCallback = beeCopterCompression::ProgressCallback;
using ArchiveEntry = beeCopterCompression::ArchiveEntry;
using ArchiveStats = beeCopterCompression::ArchiveStats;
using EntryFilter = beeCopterCompression::EntryFilter;

using beeCopterCompression::kDefaultFilePermissions;
