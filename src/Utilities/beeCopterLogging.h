...
Q_DECLARE_LOGGING_CATEGORY(beeCopterLoggingLog)

class beeCopterLogging : public QStringListModel
{
    Q_OBJECT

public:
    explicit beeCopterLogging(QObject *parent = nullptr);
    ~beeCopterLogging();

    /// Get the singleton instance
    static beeCopterLogging *instance();
